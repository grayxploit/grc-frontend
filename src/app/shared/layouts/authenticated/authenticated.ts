...
export class Authenticated {
  ...
  get navItems(): NavItem[] {
    ...
    const baseItems: NavItem[] = [
      {
        ...
        name: 'Dashboard',
        subItems: [{ name: 'Overview', path: '/dashboard' }],
      },
      {
        ...
        subItems: [
          ...
          { path: 'framework-categories', name: 'Categories' },
        ],
      },
      {
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z" fill="currentColor"></path></svg>`,
    ...
    if (role === 'superadmin') {
      baseItems.push({
        name: 'Super Admin',
        icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3L19 6V11C19 15.97 15.97 20 11 20C6.03 20 3 15.97 3 11V6L12 3Z" fill="currentColor"></path></svg>`,
        subItems: [{ path: 'superadmin-only', name: 'Super Admin' }],
      });
    }
    ...
    if (role === 'superadmin' || role === 'admin') {
      baseItems.push({
        name: 'Admin',
        icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2L20 5V11C20 16.52 16.42 21.27 11 22C5.58 21.27 2 16.52 2 11V5L12 2Z" fill="currentColor"></path></svg>`,
        subItems: [{ path: 'admin-only', name: 'Admin Area' }],
      });
    }
    ...
    if (role === 'user' || role === 'admin' || role === 'superadmin') {
      baseItems.push({
        name: 'User',
        icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 4C9.79 4 8 5.79 8 8C8 10.21 9.79 12 12 12C14.21 12 16 10.21 16 8C16 5.79 14.21 4 12 4ZM6 18C6 15.79 8.69 14 12 14C15.31 14 18 15.79 18 18V20H6V18Z" fill="currentColor"></path></svg>`,
        subItems: [{ path: 'user-only', name: 'User Area' }],
      });
    }
